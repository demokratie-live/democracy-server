...
export type ResolversTypes = {
  ...
  DeputyProcedure: ResolverTypeWrapper<DeepPartial<Omit<DeputyProcedure, 'procedure'> & { procedure?: Maybe<ResolversTypes['Procedure']> }>>,
  ...
  VoteResult: ResolverTypeWrapper<DeepPartial<Omit<VoteResult, 'deputyVotes'> & { deputyVotes?: Maybe<Array<Maybe<ResolversTypes['DeputyVote']>>> }>>,
  PartyVote: ResolverTypeWrapper<DeepPartial<PartyVote>>,
  Deviants: ResolverTypeWrapper<DeepPartial<Deviants>>,
  DeputyVote: ResolverTypeWrapper<DeepPartial<Omit<DeputyVote, 'deputy'> & { deputy?: Maybe<ResolversTypes['Deputy']> }>>,
  ...
  ProceduresHavingVoteResults: ResolverTypeWrapper<DeepPartial<Omit<ProceduresHavingVoteResults, 'procedures'> & { procedures?: Maybe<Array<Maybe<ResolversTypes['Procedure']>>> }>>,
  SearchProcedures: ResolverTypeWrapper<DeepPartial<Omit<SearchProcedures, 'procedures'> & { procedures?: Maybe<Array<Maybe<ResolversTypes['Procedure']>>> }>>,
...
export type ResolversParentTypes = {
  ...
  DeputyProcedure: DeepPartial<Omit<DeputyProcedure, 'procedure'> & { procedure?: Maybe<ResolversParentTypes['Procedure']> }>,
  VoteSelection: DeepPartial<VoteSelection>,
  Procedure: ProcedureProps,
  Document: DeepPartial<Document>,
  VoteResult: DeepPartial<Omit<VoteResult, 'deputyVotes'> & { deputyVotes?: Maybe<Array<Maybe<ResolversParentTypes['DeputyVote']>>> }>,
  PartyVote: DeepPartial<PartyVote>,
  Deviants: DeepPartial<Deviants>,
  DeputyVote: DeepPartial<Omit<DeputyVote, 'deputy'> & { deputy?: Maybe<ResolversParentTypes['Deputy']> }>,
  ...
  ProceduresHavingVoteResults: DeepPartial<Omit<ProceduresHavingVoteResults, 'procedures'> & { procedures?: Maybe<Array<Maybe<ResolversParentTypes['Procedure']>>> }>,
  SearchProcedures: DeepPartial<Omit<SearchProcedures, 'procedures'> & { procedures?: Maybe<Array<Maybe<ResolversParentTypes['Procedure']>>> }>,
...
export type UnionDirectiveResolver<Result, Parent, ContextType = GraphQlContext, Args = UnionDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type AbstractEntityDirectiveArgs = {   discriminatorField: Scalars['String'];
  additionalFields?: Maybe<Array<Maybe<AdditionalEntityFields>>>; };

export type AbstractEntityDirectiveResolver<Result, Parent, ContextType = GraphQlContext, Args = AbstractEntityDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type EntityDirectiveArgs = {   embedded?: Maybe<Scalars['Boolean']>;
  additionalFields?: Maybe<Array<Maybe<AdditionalEntityFields>>>; };

export type EntityDirectiveResolver<Result, Parent, ContextType = GraphQlContext, Args = EntityDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type ColumnDirectiveArgs = {   overrideType?: Maybe<Scalars['String']>; };

export type ColumnDirectiveResolver<Result, Parent, ContextType = GraphQlContext, Args = ColumnDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type IdDirectiveArgs = {  };

export type IdDirectiveResolver<Result, Parent, ContextType = GraphQlContext, Args = IdDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type EmbeddedDirectiveResolver<Result, Parent, ContextType = GraphQlContext, Args = EmbeddedDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;

export type MapDirectiveArgs = {   path: Scalars['String']; };

export type MapDirectiveResolver<Result, Parent, ContextType = GraphQlContext, Args = MapDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
...
export type CommunityVotesResolvers<ContextType = GraphQlContext, ParentType extends ResolversParentTypes['CommunityVotes'] = ResolversParentTypes['CommunityVotes']> = {
  ...
  total?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>,
  constituencies?: Resolver<Maybe<Array<Maybe<ResolversTypes['CommunityConstituencyVotes']>>>, ParentType, ContextType>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};
...
export type DeputyResolvers<ContextType = GraphQlContext, ParentType extends ResolversParentTypes['Deputy'] = ResolversParentTypes['Deputy']> = {
  ...
  procedures?: Resolver<Maybe<Array<Maybe<ResolversTypes['DeputyProcedure']>>>, ParentType, ContextType, RequireFields<DeputyProceduresArgs, never>>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};
...
export type MutationResolvers<ContextType = GraphQlContext, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = {
  ...
  requestCode?: Resolver<Maybe<ResolversTypes['CodeResult']>, ParentType, ContextType, RequireFields<MutationRequestCodeArgs, 'newPhone'>>,
  requestVerification?: Resolver<Maybe<ResolversTypes['VerificationResult']>, ParentType, ContextType, RequireFields<MutationRequestVerificationArgs, 'code' | 'newPhoneHash'>>,
  addToken?: Resolver<Maybe<ResolversTypes['TokenResult']>, ParentType, ContextType, RequireFields<MutationAddTokenArgs, 'token' | 'os'>>,
  ...
  finishSearch?: Resolver<Maybe<ResolversTypes['SearchTerm']>, ParentType, ContextType, RequireFields<MutationFinishSearchArgs, 'term'>>,
  signUp?: Resolver<Maybe<ResolversTypes['Auth']>, ParentType, ContextType, RequireFields<MutationSignUpArgs, 'deviceHashEncrypted'>>,
  vote?: Resolver<Maybe<ResolversTypes['Vote']>, ParentType, ContextType, RequireFields<MutationVoteArgs, 'procedure' | 'selection'>>,
};
...
export type QueryResolvers<ContextType = GraphQlContext, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  deputiesOfConstituency?: Resolver<Maybe<Array<Maybe<ResolversTypes['Deputy']>>>, ParentType, ContextType, RequireFields<QueryDeputiesOfConstituencyArgs, 'constituency'>>,
  notificationSettings?: Resolver<Maybe<ResolversTypes['NotificationSettings']>, ParentType, ContextType>,
  ...
  proceduresById?: Resolver<Maybe<Array<Maybe<ResolversTypes['Procedure']>>>, ParentType, ContextType, RequireFields<QueryProceduresByIdArgs, 'ids'>>,
  proceduresByIdHavingVoteResults?: Resolver<Maybe<ResolversTypes['ProceduresHavingVoteResults']>, ParentType, ContextType, RequireFields<QueryProceduresByIdHavingVoteResultsArgs, never>>,
  notifiedProcedures?: Resolver<Maybe<Array<Maybe<ResolversTypes['Procedure']>>>, ParentType, ContextType>,
  searchProcedures?: Resolver<Maybe<Array<Maybe<ResolversTypes['Procedure']>>>, ParentType, ContextType, RequireFields<QuerySearchProceduresArgs, 'term'>>,
  searchProceduresAutocomplete?: Resolver<Maybe<ResolversTypes['SearchProcedures']>, ParentType, ContextType, RequireFields<QuerySearchProceduresAutocompleteArgs, 'term'>>,
  votedProcedures?: Resolver<Maybe<Array<Maybe<ResolversTypes['Procedure']>>>, ParentType, ContextType>,
  proceduresWithVoteResults?: Resolver<Maybe<Array<Maybe<ResolversTypes['Procedure']>>>, ParentType, ContextType, RequireFields<QueryProceduresWithVoteResultsArgs, 'procedureIds'>>,
  mostSearched?: Resolver<Maybe<Array<Maybe<ResolversTypes['SearchTerm']>>>, ParentType, ContextType>,
...
export type VoteResultResolvers<ContextType = GraphQlContext, ParentType extends ResolversParentTypes['VoteResult'] = ResolversParentTypes['VoteResult']> = {
  ...
  deputyVotes?: Resolver<Maybe<Array<Maybe<ResolversTypes['DeputyVote']>>>, ParentType, ContextType, RequireFields<VoteResultDeputyVotesArgs, never>>,
  __isTypeOf?: isTypeOfResolverFn<ParentType>,
};
