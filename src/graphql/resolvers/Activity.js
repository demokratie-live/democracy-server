...
export default {
  Query: {
    activityIndex: isLoggedin.createResolver(
      async (parent, { procedureId }, { ProcedureModel, ActivityModel, user }) => {
  ...
  Mutation: {
    increaseActivity: isVerified.createResolver(
      async (parent, { procedureId }, { ProcedureModel, ActivityModel, device, phone }) => {
